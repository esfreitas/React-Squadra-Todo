...
const TaskLists = ()=>{
        ...
        },
        {
            ...
            render: (text, record) => {
                ...
                <Space>
                    ...
                    <Popconfirm title="Confirmar Exclusão da Lista?" onConfirm={() => onDelete(record.id)} okText="Sim" cancelText="Não" cancelText="Cancelar">
                        <Button icon={<FaTrash />} />
                    </Popconfirm>
                </Space>
                );
    ...
    return(
        <>
            <PageHeader title="Listas" subTitle="Minhas Listas de Tarefas" />
